 ...
 * @function init
 */
void ArmGroundCommand::init(std::string _reference_frame)
{
...
int main(int argc, char* argv[])
{
  ...
  std::string reference_frame = "ground/big_arm_link_1";
  ArmGroundCommand agc(node);
  agc.init(reference_frame);
